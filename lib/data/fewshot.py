...
def load_coco_json(json_file, image_root, metadata, dataset_name):
    ...
    if is_shots:
        fileids = {}
        split_dir = os.path.join(os.environ.get("DETECTRON2_DATASETS", "/your_path/datasets/coco"), "cocosplit") # enter your path
...
def register_all_coco(root=None):
    ...
    root = root or os.environ.get("DETECTRON2_DATASETS", "/your_path/datasets/") # enter your path
    ...
    METASPLITS = [
        ...
        (
            "fs_coco_trainval_base",
            "coco/trainval2014",
            "coco/cocosplit/datasplit/trainvalno5k.json",
        ),
        
        ("fs_coco_test_all", "coco/val2014", "coco/cocosplit/datasplit/5k.json"),
